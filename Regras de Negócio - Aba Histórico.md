...
Este documento descreve as regras de negócio da **Aba Histórico** (painel 4) do módulo de Títulos de Crédito (TC), no mesmo formato de [Regras de Negócio - Aba Liquidação.md](./Regras%20de%20Negócio%20-%20Aba%20Liquidação.md).
